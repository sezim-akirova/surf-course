...
class SettingsRepository {
  ...
  Future<ThemeMode> getThemeMode() async {
    String themeModeString =
        preferences.getString(_themeMode) ?? ThemeMode.system.toString();
  ...
  Future<AppThemeScheme> getAppThemeScheme() async {
    String appThemeSchemeString =
        preferences.getString(_isAppThemeScheme) ?? 'scheme1';
    return AppThemeScheme.values
        .firstWhere((e) => e.toString() == appThemeSchemeString);
  }
}
